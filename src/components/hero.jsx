...
const Hero = () => {
  ...
  return (
    <section id="hero-section" className="bg-linear-to-br from-[#eef4fb] to-white px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-32 flex justify-center">
      ...
      <div className="w-full max-w-5xl text-center">
        ...
        {showMap && (
          <div className="mt-12 w-full flex flex-col items-center">
            <div className="w-full max-w-3xl rounded-xl overflow-hidden shadow-2xl border-4 border-[#1d4f91]">
              <iframe
