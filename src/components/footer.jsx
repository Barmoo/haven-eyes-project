...
const Footer = () => {
  return (
    <footer className="bg-[#004B2E] text-white">
      {/* Main Footer Content */}
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <a href="tel:+233557767766" className="text-white/80 hover:text-white transition-colors">
                    +233 55 776 776
                  </a>
                </div>
                <div className="flex items-center space-x-3">
                  ...
                  <a href="mailto:info@haveneye.com" className="text-white/80 hover:text-white transition-colors">
                    info@haveneye.com
                  </a>
                </div>
              </div>
