...
const About = () => {
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero banner */}
      <div className="bg-linear-to-r from-[#3d6b1f] to-[#2d5016] text-white py-16 px-4 text-center">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-14 space-y-14">
        ...
        <section>
          <div className="flex items-center gap-3 mb-4">
            <div className="w-1 h-8 bg-[#3d6b1f] rounded-full"></div>
          ...
          <ul className="space-y-2">
            {policies.map((policy, i) => (
              <li key={i} className="flex items-start gap-3 text-gray-600">
                <span className="mt-1.5 w-2 h-2 rounded-full bg-[#3d6b1f] shrink-0"></span>
                {policy}
              </li>
            ))}
          </ul>
